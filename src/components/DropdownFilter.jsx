            ...
            <li className="py-1 px-3">
              <label className="flex items-center">
                <input
                  ...
                  className="form-checkbox"
                />
                <span className="text-sm font-medium ml-2">Contrato 3</span>
              </label>
            </li>
            <li className="py-1 px-3">
              <label className="flex items-center">
            ...
            <li className="py-1 px-3">
              <label className="flex items-center">
                <input
                  ...
                  className="form-checkbox"
                />
                <span className="text-sm font-medium ml-2">Contrato 5</span>
              </label>
            </li>
            <li className="py-1 px-3">
              <label className="flex items-center">
                <input
                  ...
                  className="form-checkbox"
                />
                <span className="text-sm font-medium ml-2">Contrato 6</span>
              </label>
            </li>
          </ul>
